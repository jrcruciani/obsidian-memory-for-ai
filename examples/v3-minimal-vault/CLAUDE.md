...
- Proposed agent writes go to `memory/_inbox/{agent-id}/` and are compacted later.
...
3. Use `tools/reflect.py` for proposed reflections and `tools/compact.sh` for review.
